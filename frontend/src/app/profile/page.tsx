  ...
  if (!user) {
    return (
      <div className="container-custom py-20 text-center">
        ...
        <p className="text-medium mb-4">Please sign in to view your profile.</p>
    ...
    <div className="container-custom py-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-4">
        ...
        <div className="lg:col-span-1">
          <div className="card p-4 sm:p-4 text-center">
            {/* Avatar */}
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4">
            <div className="card p-3 sm:p-4 text-center">
              ...
              <p className="text-xs text-medium">Total Orders</p>
            </div>
            <div className="card p-3 sm:p-4 text-center">
              <p className="text-base sm:text-xl font-bold text-success">
                {deliveredOrders}
              </p>
              <p className="text-xs text-medium">Delivered</p>
            </div>
            <div className="card p-3 sm:p-4 text-center">
              <p className="text-base sm:text-xl font-bold text-yellow-600">
                {pendingOrders}
              </p>
              <p className="text-xs text-medium">In Progress</p>
            </div>
            <div className="card p-3 sm:p-4 text-center">
              ...
              <div className="space-y-3">
                {recentOrders.map((order) => (
                  <Link
                    ...
                    className="flex items-center justify-between py-2 border-b border-border last:border-b-0 hover:bg-light -mx-2 px-2 rounded-lg transition-colors"
                  >
                    <div>
          ...
          <div className="card p-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <p className="text-xs text-medium mb-1">First Name</p>
                <p className="text-dark font-medium">
                  {user.firstName || "—"}
                </p>
              </div>
              <div>
                <p className="text-xs text-medium mb-1">Last Name</p>
                <p className="text-dark font-medium">
                  {user.lastName || "—"}
                </p>
              </div>
              <div>
                <p className="text-xs text-medium mb-1">Email</p>
                <p className="text-dark font-medium">
                  {user.emailAddresses[0]?.emailAddress || "—"}
                </p>
              </div>
              <div>
                <p className="text-xs text-medium mb-1">Username</p>
                <p className="text-dark font-medium">
                  {user.username || "—"}
                </p>
              </div>
