...
export default function AdminSidebar({ open, onClose }: AdminSidebarProps) {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside
        className={`fixed top-0 left-0 z-50 h-full w-56 bg-dark text-white transform transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:z-auto lg:min-h-screen lg:sticky ${
