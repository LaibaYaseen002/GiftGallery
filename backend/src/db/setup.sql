...
-- Clothes
  ...
  ('Mens Formal Tie Set', 'Premium silk tie with matching cufflinks and pocket square.', 34.99, 'https://images.unsplash.com/photo-1598971457999-ca4ef48a9a71?w=500', (SELECT id FROM categories WHERE slug = 'clothes')),
...
-- Perfumes
  ...
  ('Oud Wood Cologne', 'Rich oud wood cologne with amber and sandalwood undertones.', 89.99, 'https://images.unsplash.com/photo-1523293182086-7651a899d37f?w=500', (SELECT id FROM categories WHERE slug = 'perfumes')),
...
-- Other Gifts
  ('Scented Candle Set', 'Set of 3 premium scented candles — lavender, vanilla, and cinnamon.', 24.99, 'https://images.unsplash.com/photo-1603006905003-be475563bc59?w=500', (SELECT id FROM categories WHERE slug = 'other-gifts')),
  ...
  ('Photo Frame Set', 'Set of 3 elegant wooden photo frames in different sizes.', 29.99, 'https://images.unsplash.com/photo-1607344645866-009c320b63e0?w=500', (SELECT id FROM categories WHERE slug = 'other-gifts'));
